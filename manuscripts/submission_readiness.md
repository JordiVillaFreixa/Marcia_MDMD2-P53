# JCIM Application Note Submission Readiness

This draft is aligned to the JCIM Application Note framing for the repository:

- `Marcia-Automated-Workflow-for-Protein-Ligand-LIE-Linear-Interaction-Energy-Calculations`
...
- Add a short reviewer walkthrough for one ligand and one complex branch once the public repository structure is frozen.
...
- `../../Marcia-Automated-Workflow-for-Protein-Ligand-LIE-Linear-Interaction-Energy-Calculations/README.md`
- `../../Marcia-Automated-Workflow-for-Protein-Ligand-LIE-Linear-Interaction-Energy-Calculations/ligands/README.md`
- `../../Marcia-Automated-Workflow-for-Protein-Ligand-LIE-Linear-Interaction-Energy-Calculations/complex/README.md`
